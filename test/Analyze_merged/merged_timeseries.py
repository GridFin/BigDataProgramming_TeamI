...
# # --- after RMSE / MAE print ---
# print("RMSE / mean =", rmse / y_test.mean())

# print("\nTop‑20 예측값 (디버깅)")
# print(test_meta.nlargest(20, "예측_매출")[["행정동명", "업종", "예측_매출"]])

# print("\n분기별 총매출 예측 증감율")
# print(rolling_df.groupby("기준_년분기_코드")["예측_매출"].sum().pct_change().tail())
